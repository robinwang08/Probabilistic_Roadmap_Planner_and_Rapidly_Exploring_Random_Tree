...
// This class is the collision detection class;
// the algorithm use the cross product of winding number to 
...
class CollisionChecker {
    ...
    {
	CollisionChecker polygonIntersect = new CollisionChecker();
    ...
    public static double trial(double[][] a, double[][] b)
    {
 ...
 //    {
	...
	// double a9[][] = {{0, 0}, {0, 1}, {1, 0}};
	// double b9[][] = {{0, -1}, {1, 1}, {2, 1}};
